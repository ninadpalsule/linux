...
#define pr_fmt(fmt) "clk-ast2700: " fmt
...
static const struct aspeed_gate_data aspeed_g7_soc1_gates[] = {
	/*				    clk rst  name		parent	 flags */
	[AST2700_SOC1_CLK_GATE_LCLK0]	= { AST2700_SOC1_CLK_GATE_LCLK0,	ASPEED_RESET_LPC0,	"lclk0-gate",	NULL,	CLK_IS_CRITICAL }, /* LPC0 */
	[AST2700_SOC1_CLK_GATE_LCLK1]	= { AST2700_SOC1_CLK_GATE_LCLK1,	ASPEED_RESET_LPC1,	"lclk1-gate",	NULL,	CLK_IS_CRITICAL }, /* LPC1 */
	[AST2700_SOC1_CLK_GATE_ESPI0CLK]= { AST2700_SOC1_CLK_GATE_ESPI0CLK, 	ASPEED_RESET_ESPI0,	"espi0clk-gate",NULL,	CLK_IS_CRITICAL }, /* ESPI0 */
	[AST2700_SOC1_CLK_GATE_ESPI1CLK]= { AST2700_SOC1_CLK_GATE_ESPI1CLK, 	ASPEED_RESET_ESPI1,	"espi1clk-gate",NULL,	CLK_IS_CRITICAL }, /* ESPI1 */
	[AST2700_SOC1_CLK_GATE_SDCLK]	= { AST2700_SOC1_CLK_GATE_SDCLK,	ASPEED_RESET_SD,	"sdclk",	"sdclk-mux", CLK_IS_CRITICAL }, /* SDCLK */
	[ASPEED_CLK_GATE_GCLK]		= {  2,  7, "gclk-gate",	NULL,	 0 },	/* 2D engine */
	/* vclk parent - dclk/d1clk/hclk/mclk */
	[ASPEED_CLK_GATE_VCLK]		= {  3, -1, "vclk-gate",	NULL,	 0 },	/* Video Capture */
	[ASPEED_CLK_GATE_BCLK]		= {  4,  8, "bclk-gate",	"bclk",	 CLK_IS_CRITICAL }, /* PCIe/PCI */
...
static void __init aspeed_g7_cc1_init(struct device_node *np)
{

}
CLK_OF_DECLARE_DRIVER(aspeed_cc1_g7, "aspeed,ast2700-scu1", aspeed_g7_cc1_init);